                 ...
                 <div class="Outer-Frame">
                    <div class="Left-side">
                        ...
                        <div class="section-first">
                            ...
                            <div id="Reg form">
                        <div class="name">
                            <TextField  label="First name" id="FirstName" size="small" margin="normal" sx={{marginRight:"5px"}} />
                            <TextField  label="Last name" id="LastName" size="small" margin="normal" sx={{marginLeft:"5px"}}/>
                        </div>
                        <TextField fullWidth label="Username"  id="fullWidth" size="small" margin="normal" helperText="you can use numbers,letters and periods" />
                        <div><p class="text">Use my current email address instead</p></div>
                        <div class="password">
                            <TextField label="Password" id="password" size="small" margin="normal" sx={{marginRight:"5px"}} />
                            <TextField label="Confirm" id="passwordconfirm" size="small" margin="normal" sx={{marginLeft:"5px"}}/>
                        </div>
